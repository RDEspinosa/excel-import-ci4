...
--
-- Servidor: localhost
-- Tiempo de generación: 24-04-2025 a las 05:03:27
...
CREATE TABLE `importaciones` (
  ...
  `tablas_procesadas` text DEFAULT NULL,
  `registros_insertados` int(11) DEFAULT 0,
  `errores` int(11) DEFAULT 0,
  `errores_csv` varchar(255) DEFAULT NULL,
